...
#End Region
    ...
    Public Function boktipsAuthorNameBaseInfo(antal As Integer) As List(Of boktipsInfo)

        Dim authorObj = From bt In _linqObj.ajKat_BoktipsByDate(antal)
                        Select bt
